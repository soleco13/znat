...
/**
 * Сколько держим режим, включённый сервером по бэклогу (клиент свой снимает
 * сам). Короткое удержание раскачивало доску «волнами» — как и у клиента.
 */
const SERVER_POOR_HOLD_MS = 2 * 60_000;
