# Текущий этап: Э8 — Движок заданий: плеер
...
- [ ] Э8.2 Таблицы `materials`, `material_versions`, `activities`, `responses`. Миграции.
- [ ] Э8.3 Движок проверки на сервере + табличные тесты на все типы, включая граничные случаи.
- [ ] Э8.4 Плеер: типы 1–5.
- [ ] Э8.5 Плеер: типы 6–10.
- [ ] Э8.6 Выдача задания в уроке: индивидуальный канал, не через Yjs.
- [ ] Э8.7 Автосохранение ответов каждые 5 сек + при потере фокуса.
- [ ] Э8.8 Панель прогресса класса.
- [ ] Э8.9 Агрегированная аналитика по вопросу.
- [ ] Э8.10 Разбор: показать правильные ответы всем, вынести ответ на доску.
- [ ] Э8.11 Режим «домашняя работа» вне урока.
- [ ] Э8.12 Очередь ручной проверки с рубриками для `open_answer`.
