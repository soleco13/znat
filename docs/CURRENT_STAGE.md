...
**Осталось по Э12.7:** §6.1/6.3/6.4 — каркас `RoomShell` (верхняя строка,
нижняя панель управления, левый выдвижной блок, панели чат/участники),
перенос board/deck/activity/recording в стейдж без переписывания логики,
`variant="filmstrip"` в не-плиточном режиме. `RoomPage` сейчас — длинная
вертикальная лента панелей, каркаса ещё нет.

**Осталось по Э12:** Э12.7 (каркас урока) → Э12.8 (назначение материалов
уроку, доделать) → Э12.9 (миграция на dev, ТЗ/ПЛАН/CLAUDE.md, гейт,
