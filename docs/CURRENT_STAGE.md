...
**Осталось по Э12.7 (полировка):** доска в стейдже — фикс. `70vh` у
`Board`, лучше `flex-1`; синхрон доски у всех (сейчас локальный
переключатель `stageView`); эмодзи-реакции в чате; адаптив нижней панели
на узких экранах; демонстрация слайдов гостю (§6.2, слайд-URL).
