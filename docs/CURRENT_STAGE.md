...
- [x] Э3.9 Курсоры/viewport через awareness, «следовать за учителем».
- [x] Э3.10 Загрузка изображений на доску.
- [x] Э3.11 Undo/redo в мультиплеере (`Y.UndoManager`, scope по клиенту).
- [x] Э3.12 Лимит 500 элементов на страницу.
